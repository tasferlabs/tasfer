...
import type { HostClipboard } from "@tasfer/editor/actions/clipboard";
import { createFeatureMarkInRange } from "@tasfer/editor/actions/structured-marks";
import {
  type ChangeApi,
  type DocRange,
  Editor,
} from "@tasfer/editor/entries/editor";
...
import type { Operation, ViewportState } from "@tasfer/editor/state-types";
