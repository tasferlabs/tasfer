/**
 * @cypherkit/provider-indexeddb — local-first persistence for the editor.
 *
 * Attach to any `@cypherkit/editor` Doc to mirror its CRDT op log into
 ...
 * `@cypherkit/provider-webrtc`) on the same doc: each ignores only its own
