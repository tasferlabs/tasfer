...
export async function generateMetadata({
  ...
  // Per-locale share card — the Arabic one carries the تصفير wordmark and
  // Arabic copy. Both are generated by scripts/generate-og.mjs.
  const ogImage = lang === "ar" ? "/og.ar.png" : "/og.png";

  return {
    metadataBase: new URL(SITE_ORIGIN),
    title: { default: title, template: `%s — ${lang === "ar" ? "تصفير" : "Tasfer"}` },
    description,
    applicationName: lang === "ar" ? "تصفير" : "Tasfer",
    icons: { icon: "/logo.png" },
