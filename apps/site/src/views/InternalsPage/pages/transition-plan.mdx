---
title: "Transition Plan: Decentralized Cypher"
date: "2026-03-19"
summary: "The plan that reshaped Cypher — dropping the Postgres/Express server in favor of on-device SQLite, cryptographic identity, and P2P sync. What changed, what stayed."
source: "docs/transition-plan.md"
---

> Before this, Cypher was going to be a product — but the world doesn't need just another note-taking app. There's a real problem here, and no one is addressing it.
