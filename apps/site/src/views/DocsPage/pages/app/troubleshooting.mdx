...
export const faqs = [
  ...
  ["What happens if the Cypher project disappears?", "Your files are plain markdown on your disk, untouched. The app is AGPL-3.0, so the source can be built and maintained by anyone. Nothing about your data depends on us existing."],
