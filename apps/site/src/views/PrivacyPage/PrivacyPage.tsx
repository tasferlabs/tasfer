  ...
  return (
    <div className="privacy">
      ...
      <section className="privacy-content">
        ...
        <h1 className="privacy-title">{t("privacy.title", "privacy policy")}</h1>
        ...
        <div className="privacy-items">
          ...
          <div className="privacy-item">
            ...
            <div>
              ...
              <p>{t("privacy.p2pSyncDesc", "When you collaborate, data flows directly between devices over encrypted WebRTC connections. Our signaling relay only helps peers find each other — it never sees your content.")}</p>
            </div>
          </div>
          ...
          <div className="privacy-item">
            ...
            <div>
              ...
              <p>{t("privacy.noAnalyticsDesc", "No cookies, no trackers, no telemetry. We don't know who you are, what you write, or how you use the app.")}</p>
            </div>
          </div>
          ...
          <div className="privacy-item">
            ...
            <div>
              ...
              <p>{t("privacy.noThirdPartyDesc", "There is no data to share because there is no data to collect. No advertising, no partnerships, no data brokers.")}</p>
            </div>
          </div>
          ...
          <div className="privacy-item">
            ...
            <div>
              ...
              <p>{t("privacy.openSourceDesc", "Don't take our word for it. The entire codebase is open source — you can verify every claim on this page yourself.")}</p>
            </div>
          </div>
        </div>
      </section>
