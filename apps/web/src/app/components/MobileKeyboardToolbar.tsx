...
const ICONS: Record<MobileToolbarIcon, React.ReactNode> = {
  ...
  reposition: <Move className="size-5" />,
  ...
  row_select: <Rows3 className="size-5" />,
  column_select: <Columns3 className="size-5" />,
  ...
  column_left: <MoveLeft className="size-5" />,
  column_right: <MoveRight className="size-5" />,
