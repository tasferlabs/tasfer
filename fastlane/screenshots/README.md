...
device slot. Numeric filename prefixes control their order. The selected light
and dark phone/iPad compositions are also published to
`apps/web/public/screenshots/pwa-*.png` for the web app manifest.
...
`fastlane/screenshots/source/` without contacting a server.
